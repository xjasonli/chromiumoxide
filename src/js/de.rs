...
// Currently, we use a thread-local context for all deserializer nested calls,
// for more information, see https://github.com/chromiumoxide/chromiumoxide/pull/1015
//
// If the issue is fixed, we can remove this and use the commented code below.
